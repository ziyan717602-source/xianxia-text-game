...
当前阶段：阶段 1C 已完成；阶段 2 已接入普通出身、灵根五行、功法相性、炼丹/丹毒、稳息散稳冲、清躁丸/丹毒入脉事件、短闭关、外门短差/供给、炼气小境界突破和筑基大瓶颈第一版。下一优先级见 `PLAN.md` 与 `docs/project-status.md`。
...
近期继续阶段 2：筑基收功/长期后果、宗门任务链/规矩惩罚、更多丹方/丹毒长期后果、阵法/洞府升格。不要回头重做阶段 1C 的普通开局、引气入体、炼气一层、日课和早期手感基准，除非是修 bug 或平衡回归。
