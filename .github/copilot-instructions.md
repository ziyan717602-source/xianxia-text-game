...
Follow `AGENTS.md` as the project source of truth. Before implementation work, read `docs/project-status.md` and `PLAN.md`; for design work, also read `docs/design-direction.md`.
