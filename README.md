...
一款受 `A Dark Room` 启发的原创纯文字修仙增量叙事游戏。当前仓库已完成阶段 1C 原型：核心逻辑、地点、关系账本、状态调制事件、世界日志、localStorage 存档、早期数值基准和基础测试已经建立。
...
1. 扩展普通开局路线：山居、乡塾、坊市、外门、游方。
2. 进入阶段 2：灵根五行、炼丹丹毒、突破瓶颈和宗门影子系统。
