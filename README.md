...
一款受 `A Dark Room` 启发的原创纯文字修仙增量叙事游戏。凡人→炼气→筑基早期链路已验证可玩；金丹及更高境界（元婴→化神→合体→大乘→渡劫）为实验性草案，框架已搭建，可玩性待验证。当前仓库包含：核心逻辑、八个可选出身、灵根五行、功法相性、炼丹丹毒、九层炼气突破、筑基大瓶颈、全境界链路（高境界为草案）、道途/因果/心魔、宗门身份与规矩、洞府阵法与弟子杂役、秘境探索、飞升重置、186+ 事件、29 地点、51 功法、38 丹方、45 草药、14 秘境、466 测试用例、localStorage 存档（版本 14）已经建立。
